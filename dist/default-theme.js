module.exports = {
  ...
  "import url(https": "@theme:default",
  "ant-prefix": "ant",
  "html-selector": "html",
  ...
  "white": "#fff",
  "black": "#000",
  "primary-1": "fade(@primary-color, 20%)",
  ...
  "component-background": "#F7FAFC",
  "base-background": "#FFF",
  "popover-background": "@base-background",
  ...
  "shadow-color-inverse": "@base-background",
  ...
  "shadow-custom": "-0.5px -0.5px 1px 1px rgb(50 50 71 / 2%), 1px 1px 3px 0px rgb(50 50 71 / 8%)",
  "btn-font-weight": "400",
  ...
  "btn-default-bg": "@base-background",
  ...
  "btn-default-ghost-color": "@base-background",
  "btn-default-ghost-bg": "transparent",
  "btn-default-ghost-border": "@base-background",
  ...
  "dropdown-menu-submenu-disabled-bg": "@base-background",
  ...
  "radio-solid-checked-color": "@base-background",
  ...
  "dropdown-menu-bg": "@base-background",
  ...
  "input-border-color": "@border-color-none",
  "input-bg": "@base-background",
  "input-number-hover-border-color": "@input-hover-border-color",
  "input-number-handler-active-bg": "#f4f4f4",
  "input-number-handler-hover-bg": "@primary-5",
  "input-number-handler-bg": "@base-background",
  ...
  "mentions-dropdown-bg": "@base-background",
  "mentions-dropdown-menu-item-hover-bg": "@mentions-dropdown-bg",
  "select-border-color": "@border-color-none",
  "select-item-selected-color": "@text-color",
  "select-item-selected-font-weight": "600",
  "select-dropdown-bg": "@base-background",
  ...
  "select-background": "@base-background",
  ...
  "cascader-bg": "@base-background",
  "cascader-item-selected-bg": "@primary-1",
  "cascader-menu-bg": "@base-background",
  ...
  "modal-header-bg": "@base-background",
  ...
  "modal-content-bg": "@base-background",
  ...
  "table-filter-dropdown-bg": "@base-background",
  "table-expand-icon-bg": "@base-background",
  ...
  "badge-text-color": "@base-background",
  ...
  "card-actions-background": "@base-background",
  "card-actions-li-margin": "12px 0",
  "card-skeleton-bg": "#cfd8dc",
  "card-background": "@base-background",
  ...
  "pagination-item-bg": "@base-background",
  "pagination-item-size": "@height-base",
  "pagination-item-size-sm": "24px",
  "pagination-font-family": "@font-family",
  "pagination-font-weight-active": "500",
  "pagination-item-bg-active": "@base-background",
  "pagination-item-link-bg": "@base-background",
  "pagination-item-disabled-color-active": "@disabled-color",
  "pagination-item-disabled-bg-active": "@disabled-active-bg",
  "pagination-item-input-bg": "@base-background",
  ...
  "slider-handle-background-color": "@base-background",
  ...
  "slider-disabled-background-color": "@base-background",
  "tree-bg": "@base-background",
  ...
  "collapse-content-bg": "@base-background",
  ...
  "message-notice-content-bg": "@base-background",
  ...
  "list-customize-card-bg": "@base-background",
  ...
  "timeline-dot-bg": "@base-background",
  ...
  "steps-background": "@base-background",
  ...
  "notification-bg": "@base-background",
